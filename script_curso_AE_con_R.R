...
unlink(paste("tabla_datos_cancer_ariadna_",ano,".pdf",sep=""))

rmarkdown::render(input="funciones/tabla_datos_cancer_ariadna.Rmd",
output_dir="para_publicar",
output_file=paste("tabla_datos_cancer_ariadna_",ano,".pdf",sep=""))
